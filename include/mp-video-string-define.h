...
#define VIDEOS_CTXPOP_MENU_AUTO_PLAY_NEXT_IDS			("IDS_VPL_OPT_AUTO_PLAY_NEXT_ABB")
...
#define VIDEOS_STRING_COM_ON					VIDEOS_GET_STR("IDS_COM_BODY_ON")
#define VIDEOS_STRING_COM_OFF					VIDEOS_GET_STR("IDS_COM_BODY_OFF")
